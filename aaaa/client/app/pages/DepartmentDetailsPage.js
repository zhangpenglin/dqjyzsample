...
export default class DepartmentDetailsPage extends Component {
    ...
    componentDidMount() {
        this.setState({
            ...
            rowDataCount: this.props.rowDataCount
        });
        this.fetchData();
    }
            ...
            <View style={styles.container}>
                <ListView
                    ...
                    renderHeader={() => {
                        return (
                            <View style={{ flex: 1 }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', height: p(132), backgroundColor: '#ffffff' }}>
                                    <Text style={{ fontSize: p(48), color: '#0080cb', marginLeft: p(40), marginVertical: p(42)}}>{this.state.rowData}</Text>
                                    <Text style={{fontSize: p(36), color: '#6b6b6b', marginLeft: p(84)}}>成员数：{this.state.rowDataCount}人</Text>
                                </View>
